...
const Update = () => {
  ...
  async function load() {
    ...
    setBirthDdate(empData.birth_date);
    setGender(empData.gender);
    setSelectedCountry(empData.country);
                ...
                <div className="border-b border-gray-900/10 pb-12">
                  ...
                  <option>Mexico</option> */}
                    ...
                    <div className="col-span-full">
                      ...
                      <div className="px-8 py-2 col-span-full flex flex-row w-full">
                        <div className=" m-2 ">
                          <input
                            id="first"
                            type="checkbox"
